// ------------------------------------------------------------
//  Home — kaiastudios-feeling: hero banner, NEW IN grid, FAQ, contact
// ------------------------------------------------------------
function HomeScreen({ onNavigate, products }) {
  return (
    <main>
      ...
      <section style={{ position: 'relative', background: '#fff' }}>
        <div style={{
          ...
          <img
            src="../../assets/photos/top-lace-parque.png"
          ...
          <div className="hero-content" style={{
            ...
            <div style={{ maxWidth: 460 }}>
              <Eyebrow style={{ color: dahila.ink900 }}>Otoño 2026 — Edición a medida</Eyebrow>
              <h1 style={{
              ...
              <Button variant="primary" size="lg" onClick={() => onNavigate('tienda')}>
                Ver tienda
              </Button>
            </div>
          </div>
      ...
      <section style={{ maxWidth: 1280, margin: '88px auto 0', padding: '0 24px' }}>
        ...
        <div className="product-grid" style={{
          ...
          {products.filter(p => p.category === 'accesorios').slice(0, 4).map((p) => (
            <ProductCard key={p.id} {...p} onClick={() => onNavigate('producto', p.id)}/>
          ))}
        </div>
      </section>
      ...
      <section style={{ maxWidth: 1280, margin: '88px auto 0', padding: '0 24px' }}>
        <div className="split" style={{
          ...
          <img src="../../assets/photos/atelier-escritorio.png" alt="Atelier" style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <div style={{ marginTop: 6 }}>
              <Button variant="secondary" onClick={() => onNavigate('atelier')}>Conocé el atelier</Button>
            </div>
          </div>
        </div>
      </section>
