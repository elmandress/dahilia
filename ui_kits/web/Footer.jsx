    ...
    <footer style={{
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <div className="footer-grid" style={{
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
              <img src="../../assets/isotype-color.png" alt="" style={{ width: 36, height: 36, objectFit: 'contain' }}/>
        ...
        <div style={{
          ...
          <span>© 2026 Dahila Crochet — hecho a mano en Uruguay 🪡</span>
  ...
  return (
    <div>
      ...
      <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 9 }}>
        {items.map((it) => (
          <li key={it} style={{ fontFamily: dahila.fontSans, fontSize: 13, fontWeight: 300, color: dahila.ink700 }}>{it}</li>
        ))}
      </ul>
    </div>
  );
