...
export const alt = 'Información — Dahila Crochet'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ fontSize: 80, color: '#1F1A1B', fontWeight: 300, letterSpacing: '-0.02em', lineHeight: 1 }}>
          Información
        </div>
        <div style={{ fontSize: 26, color: '#4A4143', marginTop: 22, fontWeight: 300 }}>
          Envíos · Cambios · Cuidados · Encargos
        </div>
      </div>
    ),
    size
