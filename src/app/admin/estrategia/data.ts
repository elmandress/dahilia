...
export const NEXT_ACTIONS: TodoAction[] = [
  ...
  { id: 'link-bio-ig', label: '(Anush) Poner el link de la bio de Instagram derecho a la tienda', detail: 'Medido el 20/09: la bio NO lleva a dahila.uy/ig (esa página tuvo 5 visitantes en 90 días), y el 75% del tráfico del sitio viene de Instagram. Instagram deja poner hasta 5 links con su propio título (Editar perfil → Links → Agregar enlace externo), así que no hace falta una página intermedia: cada toque de más pierde gente. Link 1, título \"Tienda\": https://dahila.uy/tienda?utm_source=instagram&utm_medium=bio · Link 2, título \"Prenda a medida\": https://dahila.uy/encargo?utm_source=instagram&utm_medium=bio . El título tapa la dirección larga, así que en el perfil se ve prolijo, y el utm_source hace que en Pedidos aparezca \"Instagram\" en vez de \"Directo\". Por qué a /tienda y no a la home: la home rebota 78% y la tienda 64%, y quien viene de Instagram ya sabe qué vendés.', horizon: 'ya' },
  ...
  { id: 'fichas-cortas', label: 'Nuevo (19/09): revisar los borradores de 11 fichas', detail: 'YA ESTÁN ESCRITOS: entrega/descripciones-2026-09.md tiene el texto de hoy y la propuesta de cada una, armada solo con datos reales (material y talles de la ficha, horas de la tabla de precios, lo que se ve en las fotos). Corregí lo que quieras y pegalo desde Productos, o pedile a Mati que corra database/descripciones-2026-09.sql (no pisa las que ya hayas editado). Lo de antes: Set Lueur (44 letras) y Set Brisa (47) casi no tienen texto; les siguen Sweater Senda, Sweater Cherry, Granny\'s, Cardigan Amour, Bufanda Sophie, Box de regalo, Spring y Set Lurex. Por qué importa: con un par de líneas, la ficha tiene muy pocas palabras con las que Google la pueda asociar a una búsqueda ("cardigan con flores tejido a mano"), y quien llega no tiene con qué decidir sin escribirte. Ojo: que las fichas estén en el puesto 20 a 40 se explica sobre todo porque aparecen para búsquedas genéricas como "cardigan", donde compiten las tiendas grandes; el texto solo no las va a subir a la primera página. Qué poner: material, horas de tejido (están en la tabla de precios), calce, largo y cuándo te la pondrías. Nada inventado: si no sabés un dato, mejor no ponerlo.', horizon: 'ya' },
