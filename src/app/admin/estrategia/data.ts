...
export const NEXT_ACTIONS: TodoAction[] = [
  ...
  { id: 'links-perfiles', label: 'Cargar los links de tus perfiles en Configuración → Contacto', detail: 'Perfil de Google, link para reseñas, YouTube, TikTok, Facebook y Pinterest. El sitio se los declara a Google y a las IAs como tus cuentas oficiales, y el de reseñas activa dahila.uy/resena.', horizon: 'ya' },
  { id: 'resenas', label: 'Pedir reseñas a las clientas con dahila.uy/resena', detail: 'A todas, unos días después de recibir, sin descuento a cambio. El texto listo para copiar está en Novedades.', horizon: 'ya' },
  ...
  { id: 'signup-supabase', label: '(Mati) Cerrar el registro de cuentas nuevas en Supabase', detail: 'En Supabase → Authentication, apagar la opción que permite registrarse (signups). Hoy cualquiera puede crearse una cuenta y, por cómo están las reglas, tocar la tienda. Después correr los pasos 2 y 3 de database/schema-security-hardening.sql (el paso 4 NO: ya está superado).', horizon: 'ya' },
  ...
  { id: 'pedir-indexacion', label: '(Mati) Pedir a mano la indexación de las 11 páginas que faltan', detail: 'Search Console → Inspección de URLs → pegá cada una → "Solicitar indexación" (Google deja unas 10 por día). Faltan 8 notas del blog (el-crochet-se-hace-a-maquina, que-talle-de-prenda-tejida-me-queda, cardigan-de-crochet-como-elegirlo, tops-de-crochet-para-verano, materiales-de-una-prenda-tejida, set-tejido-vs-piezas-sueltas, bolsos-de-crochet-por-que-duran, cuanto-demora-una-prenda-tejida-a-mano), /tienda/sweaters, /tienda/sweater-cherry y /tienda/top-race. No uses npm run index-urls: Google acepta el aviso pero no lo registra (esa API es solo para avisos de empleo y transmisiones en vivo).', horizon: 'ya' },
