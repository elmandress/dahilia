...
// Los tokens (`dahila`) viven en ./tokens: ver ahí por qué.
...
// Re-export para los componentes de cliente. Una página de SERVIDOR que lo
// importe desde acá recibe undefined en cada color: importar de ./tokens.
export { dahila }
